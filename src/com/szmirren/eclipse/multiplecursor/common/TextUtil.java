...
public class TextUtil {
	...
	/**
	 * Scans backward from the given offset to identify a word which contains
	 * {@code offset}.
	 * 
	 * @return position (x) and length (y) of the last word in {@code text} which
	 *         contains {@code offset}, or null if no word containing
	 *         {@code offset} could be identified (i.e. offset is in whitespace)
	 */
